                                               <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyFirstWebForm.aspx.cs" Inherits="__.MyFirstWebForm" %>
    ...
    <div>
        <table>
            ...
            <tr>
                <td>Email ID</td>
                <td>
                    <asp:TextBox ID="txtEmailId" TextMode="Email" runat="server" style="margin-bottom: 0px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="RegistrationData.aspx">Show Data</a>
                    <asp:Label ID="lblSubmit" runat="server" Text="" ForeColor="Red"></asp:Label>
                </td>
            </tr>
        </table>
